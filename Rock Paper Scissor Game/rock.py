...
def result(human_choice, comp_choice):
    global user_score
    global comp_score
    print("human_choice:", human_choice, "comp_choice:",comp_choice)
    ...
    text_area = Text(master = rps, font = ("arial", 25, "italic bold"), relief = RIDGE, bg = "#033642", fg = "white", width = 26)
...
# First we will create lable and buttons
