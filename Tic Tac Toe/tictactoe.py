...
buttons = StringVar()
label = Label(tk, text = "Player 1: ", font = "Times 20 bold", bg = "white", fg = 'black', height  = 1, width  = 11)
label.grid(row = 1, column = 0)

label = Label(tk, text = "Player 2: ", font = "Times 20 bold", bg = "white", fg = 'black', height  = 1, width  = 11)
